...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('dataset', 'karate', 'Dataset string.')  # 'cora', 'citeseer', 'pubmed'
...
#model.save(sess)
with open('karate_embeddings.txt', 'w') as f:
    for emb in result_embedding:
        f.write(str(emb[0]) + " " + str(emb[1]) + "\n")